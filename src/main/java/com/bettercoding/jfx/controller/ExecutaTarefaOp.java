...
import com.bettercoding.jfx.service.EnviaEmailOpService;
            ...
            public void run() {
                Platform.runLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        listOrdemPagamento = ordemService.buscaDataOrdem(agora, TelaOrdemDePagamentoController.status_Andamento);
