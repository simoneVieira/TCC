 ...
 */
@Controller
public class OrdemDePagamentoController implements Initializable, ReceptorEmprestimo {
    ...
    public void salvarDadosOrdemPagamento() {
        ...
        if (campoCidade.getText().equals(" ") || UFCidade.getText().equals(" ")
            ...
            alert.show();
        } else if (emprestimo.getText().equals("")) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("ALERTA");
    ...
    public void receberEmprestimo(Emprestimo e) {
        this.emp = e;
        emprestimo.setText(e.getNumeroContrato() + "");
    ...
    public void comboStatus() {
        ObservableList<String> itens = FXCollections.observableArrayList();
        itens.addAll(OrdemDePagamentoController.status_Andamento, OrdemDePagamentoController.status_Resolvido);
        comboOrdem.setItems(itens);

    }

    public void chamaTelaEmprestimo() {
        EmprestimoController.setReceptor(this);
    ...
    public void selecionarItemTableViewOrdemPagamento(OrdemPagamento op) {
        ...
        emprestimo.setText(op.getEmprestimo().getNumeroContrato() + "");
